...
git_folder_location='C:\Users\TejaswiTamarana\MLOpsroot'   #replace with the local root folder location where you want to create the project folder
project_name=NYCTaxirepo-sparse   #replace with your project name
github_org_name=tejaswi2019   #replace with your github org name
project_template_github_url=https://github.com/tejaswi2019/mlops-NYCTaxifare-template  #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
